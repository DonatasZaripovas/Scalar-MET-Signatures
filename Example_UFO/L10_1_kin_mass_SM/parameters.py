...
kXza = Parameter(name = 'kXza',
                 nature = 'external',
                 type = 'real',
                 value = 1,
                 texname = '\\kappa _{\\text{za}}',
                 lhablock = 'FRBlock',
                 lhacode = [ 9 ])
