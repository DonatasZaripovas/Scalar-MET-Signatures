...
Decay_X0 = Decay(name = 'Decay_X0',
                 particle = P.X0,
                 partial_widths = {(P.a,P.a):'(kXa**2*MX0**6)/(640000.*cmath.pi*abs(MX0)**3)',
                                   (P.b,P.b__tilde__):'(((-3*kXq3**2*MB**4)/5000. + (3*kXq3**2*MB**2*MX0**2)/20000.)*cmath.sqrt(-4*MB**2*MX0**2 + MX0**4))/(16.*cmath.pi*abs(MX0)**3)',
                                   (P.g,P.g):'(kXg**2*MX0**6)/(80000.*cmath.pi*abs(MX0)**3)',
                                   (P.ta__minus__,P.ta__plus__):'((-(kXl**2*MTA**4)/5000. + (kXl**2*MTA**2*MX0**2)/20000.)*cmath.sqrt(-4*MTA**2*MX0**2 + MX0**4))/(16.*cmath.pi*abs(MX0)**3)',
                                   (P.t,P.t__tilde__):'(((-3*kXq3**2*MT**4)/5000. + (3*kXq3**2*MT**2*MX0**2)/20000.)*cmath.sqrt(-4*MT**2*MX0**2 + MX0**4))/(16.*cmath.pi*abs(MX0)**3)',
                                   (P.W__minus__,P.W__plus__):'(((3*kXw**2*MW**4)/10000. - (kXw**2*MW**2*MX0**2)/10000. + (kXw**2*MX0**4)/40000.)*cmath.sqrt(-4*MW**2*MX0**2 + MX0**4))/(16.*cmath.pi*abs(MX0)**3)',
                                   (P.Z,P.Z):'(((kXz**2*MX0**4)/40000. - (kXz**2*MX0**2*MZ**2)/10000. + (3*kXz**2*MZ**4)/10000.)*cmath.sqrt(MX0**4 - 4*MX0**2*MZ**2))/(32.*cmath.pi*abs(MX0)**3)'})
